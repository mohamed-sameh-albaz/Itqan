...
const CommunityNavBar = () => {
    ...
    return ( <div className="t-0 overflow-hidden z-50 sticky community-navbar">
        ...
        <div className="items">
            ...
            <Button color='white' className='ml-3' onClick={()=>{localStorage.removeItem('user'); nav('/')}}>Logout</Button>
        </div>
    </div> );
}
 
 
export function CommunityNavBars() {
  ...
  return (
    <div className="-m-6 max-h-[768px] w-[calc(100%+48px)] overflow-scroll" style={{backgroundColor: 'linear-gradient(to bottom, var(--primary-color), var(--lighter-primary-color))'}}>
