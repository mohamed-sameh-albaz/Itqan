const { getAllContests, addContest, getContestsByStatus, updateContestById, deleteContestById, getWrittenSubmissions, getContestType } = require("../models/contestModel");
